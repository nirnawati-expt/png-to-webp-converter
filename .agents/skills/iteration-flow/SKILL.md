...
Trigger: New chat for project work. Use default branch that user set up for this project. 

Actions: If default branch undefined: `git fetch origin main && git checkout -b [branch-name] origin/main`. Else `git pull origin main`.
