...
- Action: Evaluate current iteration, save to `reference/ee/evaluation_[N].md` (Strictly under 100 words using a bulleted list of metrics/outcomes). Delegate the entire commit, push, and PR process to the "semantic-git" skill.
